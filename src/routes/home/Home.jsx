...
function Landing() {
    ...
    // const testproduct = useProducts("attributes", { attr_gNXELwj1rl3A4p: "query" });
    ...
    //     console.log("returned data", testproduct);
    // }, [testproduct]);
                ...
                <Container className={styles.home}>
                    ...
                    <div className="homeContainer_wrap">
                        <Container className="homeContainer__content">
                            <Typography align="left" style={{ color: "#4875ca", fontWeight: "500" }} variant="subtitle1">
